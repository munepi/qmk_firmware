...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LALT, GUI_T(JP_MEISU), SFT_T(KC_SPC), KC_MOUSE, SFT_T(KC_SPC), ALT_T(JP_MKANA), KC_RCTL
  ),
  [_FN] = LAYOUT(
    ...
    _______, KC_VOLD, KC_VOLU, KC_MUTE, KC_MPLY, KC_MSTP, _______, _______, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT, _______,
